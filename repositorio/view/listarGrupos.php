...
<nav class="navbar bg-primary navbar-dark">
    <div class="container"> <a class="navbar-brand" href="listarGrupos.php">
    ...
    <div class="container">
      <div class="row">
        <div class="mx-auto col-lg-4 col-10" >
          ...
          <ul class="list-group">
            <?php 
              include '../model/crudGrupo.php';

              $resultado = buscarGrupo();

              while($linhas = mysqli_fetch_assoc($resultado)) {
                $nomeGrupo = $linhas['nomeGrupo'];
                $idGrupo = $linhas['idGrupo'];

                echo "
                <li class=' border-0 list-group-item d-flex justify-content-between align-items-center'>$nomeGrupo<a class='btn btn-danger' href='../control/controleGrupo.php?botao=excluirGrupo&idGrupo=$idGrupo' style='display: inline !important;'>Excluir</a></li>      
                ";
              } 
