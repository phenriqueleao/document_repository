...
<nav class="navbar bg-primary navbar-dark">
    <div class="container"> <a class="navbar-brand" href="admin.php">
  ...
  <nav class="navbar navbar-light">
    <div class="container"> <a class="navbar-brand text-primary" href="#">
        <p class="navbar-brand text-primary"> Bem vindo, Pedro! </p>
      </a>
      <a class="btn btn-outline-danger" href="#">Sair</a>
    </div>
  </nav>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="list-group">
            ...
            <a href="#" class="list-group-item list-group-item-action">Cadastrar Grupo</a>
            <a href="#" class="list-group-item list-group-item-action">Listar Usuários</a>
            <a href="#" class="list-group-item list-group-item-action">Listar Grupos</a>
          </div>
        </div>
