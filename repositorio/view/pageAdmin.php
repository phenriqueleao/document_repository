      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="list-group">
            ...
            <a href="listarUsuarios.php" class="list-group-item list-group-item-action">Listar Usuários</a>
            <a href="cadastrarUsuario.php" class="list-group-item list-group-item-action">Cadastrar Usuário </a>
            <a href="listarGrupos.php" class="list-group-item list-group-item-action">Listar Grupos</a>
            <a href="cadastrarGrupo.php" class="list-group-item list-group-item-action">Cadastrar Grupo</a>
          </div>
        </div>
        <div class="mx-auto col-lg-6 col-10">
          <h1>Área de Administrador</h1>
          <p>Bem vindo(a) à área de administração do site. Você poderá utilizar as funcionalidades através do menu de navegação lateral.</p>
